...
def prompt(question: str, error_message: str = "", validator: callable = lambda _: True, optional = False) -> str:
    result = None
...
def prompt_set(question: str, question_next: str, error_message: str = "", validator: callable = lambda _: True, optional = False) -> set[str]:
    result = set()
    while True:
        message = question_next if len(result) else question
        new_result = prompt(message, validator=validator, error_message=error_message, optional=optional)
