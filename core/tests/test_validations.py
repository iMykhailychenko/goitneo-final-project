...
def test_invalid_phone_number():
    ...
    # )  # to short
    # assert result.value == ValidationMessages.PHONE_NUMBER_LENGTH
...
def test_invalid_email():
    ...
    # )
    # assert result.value == ValidationMessages.INVALID_EMAIL
    ...
    # )
    # assert result.value == InfoMessages.CONTACT_CREATED
    assert True
...
def test_invalid_date():
    ...
    # )
    # assert result.value == ValidationMessages.INVALID_BIRTHDAY
